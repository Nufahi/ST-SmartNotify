...
- **Console mirror** — mirror every notification (full title + message) to the
  console. On PC that's the browser devtools console; on phone it's the
...
6. **More tab** — console mirroring, anti-spam (dedupe + throttle), and
   export/import of your config.
